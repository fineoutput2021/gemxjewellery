...
<style type="text/css">
	...
	*,
	...
	.fc-button-pair button {
		display: none;
	}

	.fc-button-pair div.fc-button {
		outline-style: none;
		box-shadow: none;
	...
	.fc-snapshots.fc-snapshots-count-0 .fc-snapshots-list-badge-counter {
		visibility: hidden;
	}

	.fc-snapshots .fc-snapshots-controls .fc-snapshots-take-wrapper {
		display: inline-block;
		vertical-align: middle;
		cursor: pointer;
	}

	.fc-snapshots .fc-snapshots-controls .fc-snapshots-take-wrapper .fc-button-pair {
		display: none;
	}
	...
	.fc-snapshots .fc-snapshots-controls .fc-snapshots-view-wrapper {
		display: inline-block;
		vertical-align: middle;
		margin: 0 12px;
	}

	.fc-snapshots .fc-snapshots-controls .fc-snapshots-view-wrapper .fc-button-pair {
		display: inline-block;
	}

	.fc-snapshots .fc-snapshots-controls .fc-snapshots-view-wrapper .fc-snapshots-view-button {
		display: inline-block;
	}
	...
	.fc-share-panel [aria-label="Close"] button {
		font-size: 30px;
		cursor: pointer;
	}

	.fc-share-panel [aria-label="Close"] button::after,
	.fc-share-panel [aria-label="Close"] button::before {
		content: " ";
		position: absolute;
	...
	*[class*="fc-"][class*="button"],
	...
	.fc-dropdown {
		...
		background: #fff url(https://cdn-prod.fluidconfigure.com/static/assets/prod/prod/customers/c1552/configureHtml/etc/assets/img/icons/dropdown-arrow.svg) calc(100% - 8px) 40%/7px no-repeat border-box;
	}

	.fc-dropdown::-ms-expand {
		display: none;
	}
	...
	.fc-menu-stone #fc-left-arrow+.fc-attribute-selector-swatch {
		display: none;
	}

	.fc-information-container .fc-button-label>span,
	.fc-share-container .fc-button-label>span,
	.fc-start-over-container .fc-button-label>span {
		display: block;
		position: relative;
		padding-left: 29px;
		height: 32px;
	...
	.fc-information-container .fc-button-label>span::before,
	.fc-share-container .fc-button-label>span::before,
	.fc-start-over-container .fc-button-label>span::before {
		content: "";
		display: inline-block;
		height: 28px;
		width: 28px;
	...
	.fc-actions-bar-container .fc-action-button {
		cursor: pointer;
		color: #6c6c6c;
		font-size: 16px;
		line-height: 1.2;
	...
	.fc-actions-bar-container .fc-action-button .fc-button {
		overflow: visible;
	}

	.fc-actions-bar-container .fc-action-button .fc-button-label {
		display: block;
	}

	.fc-actions-bar-container .fc-cart-price {
		font-size: 16px;
		font-family: "Lato", sans-serif;
		color: #333333;
	}

	.fc-actions-bar-container .fc-dropdown {
		min-width: 42px;
	}

	.fc-actions-bar-container .fc-cart-price,
	.fc-actions-bar-container .fc-qty-ring-container {
		margin-right: 19px;
	}

	.fc-actions-bar-container .fc-quantity-title {
		font-size: 16px;
		color: #333333;
		padding: 0;
		margin-right: 10px;
	...
	.fc-actions-bar-container .fc-quantity-title,
	.fc-actions-bar-container .fc-dropdown-container,
	.fc-actions-bar-container .fc-ring-size-container,
	.fc-actions-bar-container .fc-qty-container {
		display: inline-block;
		vertical-align: middle;
	}

	.fc-actions-bar-container .fc-information-container {
		display: none;
	}
	...
	.fc-information-container.fc-action-button {
		margin-right: 23px;
	}

	.fc-information-container .fc-button-label>span::before {
		background: transparent url(https://cdn-prod.fluidconfigure.com/static/assets/prod/prod/customers/c1552/configureHtml/etc/assets/img/icons/info.svg) left center/28px no-repeat border-box;
	}

	.fc-share-container .fc-button-label>span::before {
		background: transparent url(https://cdn-prod.fluidconfigure.com/static/assets/prod/prod/customers/c1552/configureHtml/etc/assets/img/icons/share.svg) left center/19px no-repeat border-box;
	}

	.fc-favorite-container {
		display: none;
	}

	.fc-snapshots .fc-snapshots-controls .fc-snapshots-take-wrapper .fc-snapshots-take-entry-icon svg,
	.fc-snapshots .fc-snapshots-controls .fc-snapshots-view-wrapper .fc-snapshots-list-badge-counter {
		display: none;
	}

	.fc-snapshots-container {
		background-color: transparent !important;
	}

	.fc-snapshots-container .fc-snapshots-view-wrapper {
		display: none !important;
	}

	.fc-snapshots-container .fc-snapshots-take-wrapper {
		*zoom: 1;
	}

	.fc-snapshots-container .fc-snapshots-take-wrapper::before,
	.fc-snapshots-container .fc-snapshots-take-wrapper::after {
		content: " ";
		display: table;
	}
	...
	.fc-snapshots-container .fc-button-pair,
	.fc-snapshots-container .fc-snapshots-take-wrapper,
	.fc-snapshots-container .fc-snapshots-take-entry-icon {
	...
	.fc-snapshots-container .fc-snapshots-take-entry-icon {
		float: left;
		background: transparent url(https://cdn-prod.fluidconfigure.com/static/assets/prod/prod/customers/c1552/configureHtml/etc/assets/img/icons/save.svg) left center/28px no-repeat border-box;
		width: 40px;
		height: 30px;
	}
	...
	.fc-start-over-container.fc-action-button {
		margin-right: auto;
	}
	...
	.fc-start-over-container .fc-button-label>span::before {
		background: transparent url(https://cdn-prod.fluidconfigure.com/static/assets/prod/prod/customers/c1552/configureHtml/etc/assets/img/icons/start-over.png) left center/30px no-repeat border-box;
		height: 30px;
		width: 30px;
	}
	...
	.fc-custom-share .fc-share-panel .fc-share-disabled {
		display: none;
	}
	...
	.fc-share-panel {
		...
		border-radius: 0;
		width: 205px;
		transition: transform 0.25s cubic-bezier(0, 0, 0.2, 1), opacity 0.25s cubic-bezier(0, 0, 0.2, 1), visibility 0.25s cubic-bezier(0, 0, 0.2, 1);
		will-change: transform, opacity, visibility;
	}

	.fc-share-panel::after,
	.fc-share-panel::before {
		position: absolute;
		bottom: -30px;
		left: 34px;
	...
	.fc-share-panel [aria-label="Close"] {
		position: absolute;
		right: 0;
		top: 0;
		z-index: 5;
	...
	.fc-share-panel [aria-label="Close"] button:focus {
		outline: none;
	}
	...
	.fc-share-panel li {
		...
		text-transform: uppercase;
		line-height: 20px;
		padding: 1.54em 10px 1.54em 70px;
		position: relative;
		text-align: left;
		color: #333333;
	}

	.fc-share-panel li::before {
		background: transparent url(https://cdn-prod.fluidconfigure.com/static/assets/prod/prod/customers/c1552/configureHtml/etc/assets/img/icons/share-icons.png) center center/30px no-repeat border-box;
		position: absolute;
		top: 50%;
		transform: translateY(-50%);
		left: 22px;
	...
	.fc-share-panel li:not(:last-child) {
		border-bottom: 1px solid #e4e4e4;
	}

	.fc-share-panel .fc-share-email::before {
		background-position: 0 -33px;
		height: 25px;
	}

	.fc-share-panel .fc-share-facebook::before {
		background-position: 0 -60px;
	}

	.fc-share-panel .fc-share-twitter::before {
		background-position: 0 -90px;
	}

	.fc-share-panel .fc-share-pinterest::before {
		...
		<div class="container-fluid p-0">
			...
			<div class="row w-100">
				<div class="col-lg-4 col-xl-4 col-md-4" style="padding: 55px;">
					<h3 class="text-center" style="    font-family: 'Calibri'!important;">Metal</h3>
					<div class="row p-0">

						<?php

	$metal_idd= App\adminmodel\CustomizeMetalColor::wherenull('deleted_at')->where('is_active', 1)->where('id', $customize_product_stonesf->cust_metal_id)->first();
		...
		$metal_image= "";
				...
				?>
						<div class="col-lg-6 col-xl-6 col-md-6 m-auto">
							<div onclick="changeMetalOnclick(<?=$metal_id;?>,<?=$product_id?>)" onmouseover="changeMetalOnhover(<?=$metal_id;?>,<?=$product_id?>)" onmouseout="changeMetalOuthover()" class="gold active"
								style="background:url(<?=base_path.$metal_image;?>);background-size:100% 100px; width: 100%;height: 100px;"></div>
...
if(!empty($customize_product_stone_single)){
	$metal_pro_stone_id= $customize_product_stone_single->id;
	...
	$cust_pro_metal_id= $customize_product_stone_single->cust_metal_id;
}else{
	$metal_pro_stone_id= "";
	$metal_pro_img= "";
	$metal_pro_name= "";
...
$customize_product = App\adminmodel\CustomizeProduct::wherenull('deleted_at')->where('is_active', 1)->where('id', $product_id)->first();

if(!empty($customize_product)){
	$category_id= $customize_product->category_id;
	$product_name= $customize_product->name;
	$product_dec= $customize_product->s_desc;
	$product_base_price= $customize_product->base_price;
}else{
	$category_id= "";
	$product_name= "";
	$product_dec= "";
...
?>
					...
					<input type="hidden" name="metal_id" id="metal_id" value="<?=$cust_pro_metal_id;?>">
					<input type="hidden" name="product_id" id="product_id" value="<?=$product_id;?>">
					<img id="myImage" src="<?=base_path.$metal_pro_img;?>" style="width: 100%;">
					<!-- <p style="text-align:center;"><?=$product_name;?></p> -->
				...
				<div class="col-lg-4 col-xl-4 col-md-4" style="padding: 55px;">
					<h3 class="" style="font-family: 'Calibri'!important;"><?=$product_name;?></h3>
					<h4>Description:</h4>
					<pclass="text-justify"><?=$product_dec?></p>
					<hr />
					<div class="d-flex">
						<p class="" id="stone_name">Choose your stone </p>&nbsp;<span id="price_a"></span>
					</div>
					<div class="scroll" style="height:310px; overflow-x: hidden; overflow-y: auto; text-align:justify; ">

						<input type="hidden" name="stone_id" id="stone_id" value="<?=$metal_pro_name;?>" st_id="<?=$metal_pro_stone_id?>">
						<?php


	$i=0;
		if($customize_product_stones){
				foreach ($customize_product_stones->unique('name') as $stone_metal) {
	?>

						<?php if($i==0) {?>
						<div class="row p-0 mt-3" style="">
							<?php } ?>


							<div class="col-lg-2 col-md-2">
								<div onclick="changeStoneOnclick(this)" onmouseover="changeStoneOnhover(this)" onmouseout="changeStoneOuthover(this)" stone-name="<?=$stone_metal->name;?>" id="st" value="<?=$stone_metal->id?>" class="red"
									style="background:url(<?=base_path.$stone_metal->stone_image;?>);background-size:100% 100px;width: 40px;height: 40px;border-radius: 50%;"></div>
							</div>
	...
	<div class="fc-action-button fc-share-container">
		<div class="fc-custom-share  " data-reactid=".0">
			...
			<!-- <div class="fc-button-pair" data-reactid=".0.1">
				<a href="whatsapp://send?text=<?=base_path."customize_diamond/".base64_encode($product_id);?>" data-action="share/whatsapp/share"
target="_blank">
				...
				<div class="fc-snapshots-view-wrapper">
					<div class="fc-button-pair fc-outline-target" role="button" tabindex="0">
						...
						<div class="fc-button fc-fancy-button fc-snapshots-view-button fc-outline-target">
							<div class="fc-ripple-effect"></div><span class="fc-button-label">Design Snapshot</span>
						</div>
					</div><span class="fc-snapshots-list-badge-counter">0</span>
				</div>
			</div>
		</div>
	</div>
	<div class="fc-action-button fc-start-over-container">
		...
		<div data-reactroot="" class="fc-button-pair" role="button">
			...
			<div class="fc-button fc-fancy-button fc-reset-recipe-button">
				<a href="<?=base_path?>customize_diamond/<?=base64_encode($product_id);?>">
	...
	<div class="fc-qty-ring-container">
		...
		<div class="fc-qty-container">
			<div data-reactroot="" class="fc-quantity-selector">
				<div class="fc-quantity-title" id="fc-quantity-selector5" aria-label="Size">Size</div>
				<div class="fc-dropdown-container">
					<select class="fc-quantity-list fc-dropdown fc-outline-target qnt" onchange="sizeset()" tabindex="0" aria-describedby="fc-quantity-selector4" id="size_<?=$product_id;?>">
	...
	<div class="fc-qty-ring-container">
		...
		<div class="fc-qty-container">
			<div data-reactroot="" class="fc-quantity-selector">
				...
				<div class="fc-dropdown-container">
					<select class="fc-quantity-list fc-dropdown fc-outline-target qnt" onchange="qntset()" tabindex="0" aria-describedby="fc-quantity-selector4" id="qtty_<?=$product_id;?>">
	...
	<div class="fc-cart-price">
		<div id="pro_price" key="price" class="fc-price bfx-price" aria-live="polite" data-price="<?=$product_base_price;?>">$<?=$product_base_price;?></div>
	</div>
	<div class="fc-cart-container">
		<div data-reactroot="" aria-label="Add To Bag" class="fc-button-pair fc-outline-target" role="button" tabindex="0">
			...
			<div class="fc-button fc-fancy-button fc-add-to-cart-button fc-outline-target">
				...
				<span class="fc-button-label" onclick="addToCartOfflineHandler2(this)" id="atb" data-product-id="<?=$product_id;?>" data-stone_id="<?=$customize_product_stonesf->name?>" data-metal_id="<?=$metal_idd->id?>" <?if($ringcheck_data->id==5){ echo
				'	size="5"' ;}else{ echo 'size=" "' ; }?> quantity="1" size="5" status="1"> Add
					To Bag </span>

				<?php }else{ ?>

				<span class="fc-button-label" onclick="addToCartOnlineHandler(this)" id="atb" data-category-id="<?=$category_id;?>" data-subcategory-id="" data-product-id="<?=$product_id;?>" size="5" user-id="<?= Session::get('user_id');?>"
					<?if($ringcheck_data->id==5){ echo 'size="5"' ;}else{ echo 'size=" "' ; }?> quantity="1" status="1">
					Add To Bag </span>
...
<script>
	function changeMetalOnclick(metal_id, pro_id) {
		// var image = document.getElementById('myImage');
		// var pro_id = $('#product_id').val().trim();
		var stone_id = $('#stone_id').val().trim();
		document.getElementById('atb').setAttribute('data-metal_id', metal_id);
		...
		$.ajax({
			url: base_path + 'get_metal_blank_data',
			method: 'post',
			data: {
				stone_id: stone_id,
				metal_id: metal_id,
			...
			success: function(response) {
				...
				if (response.data == true) {
					...
					var pro_metal_d = response.customProductMetalData;


					if (pro_metal_d != "" && pro_metal_d != null) {

						var image = document.getElementById('myImage');

						image.src = "<?=base_path?>" + pro_metal_d.stone_product_image;

						$('#metal_id').val('');
						$('#metal_id').val(pro_metal_d.cust_metal_id);

						$('#stone_id').val('');
						$('#stone_id').val(pro_metal_d.name);
...
<script>
	function changeStoneOnclick(obj) {
		// var image = document.getElementById('myImage');
		...
		// }
		var stone_id = $(obj).attr('stone-name');
		var stone_idd = $(obj).attr('value');

		document.getElementById('atb').setAttribute('data-stone_id', stone_id);


		var pro_id = $('#product_id').val().trim();
		var metal_id = $('#metal_id').val().trim();

		var base_path = $("#base_path").val();
		// alert(selectedsize);
		// alert(prod_id);
		$.ajax({
			url: base_path + 'get_metal_stone_data',
			method: 'post',
			data: {
				stone_id: stone_id,
				metal_id: metal_id,
			...
			success: function(response) {
				...
				if (response.data == true) {
					...
					var pro_stone_d = response.customProductStoneData;


					if (pro_stone_d != "" && pro_stone_d != null) {

						var image = document.getElementById('myImage');

						image.src = "<?=base_path?>" + pro_stone_d.stone_product_image;
						var price_str = "( $" + pro_stone_d.price + " )";
						var main_price = "$" + pro_stone_d.price;
						// console.log(pro_stone_d.price);
						$('#metal_id').val('');
						$('#metal_id').val(pro_stone_d.cust_metal_id);

						$('#stone_id').val('');
						$('#stone_id').val(pro_stone_d.name);

						$('#stone_name').text('');
						$('#stone_name').text(pro_stone_d.name);

						$('#price_a').text('');
						$('#price_a').text(price_str);

						$('#pro_price').text('');
						$('#pro_price').text(main_price);
...
<script>
	...
	//
	// }
	function changeMetalOnhover(metal_id, pro_id) {
		return;
		// var image = document.getElementById('myImage');
		// var pro_id = $('#product_id').val().trim();
		var stone_id = $('#stone_id').val().trim();
...
<script>
	function changeStoneOnhover(obj) {
		return;
		var stone_id = $(obj).attr('stone-name');
			...
			success: function(response) {
				...
				if (response.data == true) {
					...
					if (pro_stone_d != "" && pro_stone_d != null) {
						...
						image.src = "<?=base_path?>" + pro_stone_d.stone_product_image;
						var price_str = "( $" + pro_stone_d.price + " )";
						var price_str2 = "$" + pro_stone_d.price;
						// console.log(pro_stone_d.price);
						// $('#metal_id').val('');
						// $('#metal_id').val(pro_stone_d.cust_metal_id);
						//
...
<script>
	function qntset() {
		var x = document.getElementById("qtty_<?=$product_id;?>").value;
		// alert(x);
		document.getElementById('atb').setAttribute('quantity', x);
	}

	function sizeset() {
		var x = document.getElementById("size_<?=$product_id;?>").value;
		// alert(x);
		document.getElementById('atb').setAttribute('size', x);
	}
</script>
