...
<form action="<?=base_path?>category_products/<?=$cate_id;?>" method="get" >
  ...
  <div class="panelx">
   <div class="row">
     ...
     ?>
      ...
      <a href="<?=base_path?>category_products/<?=$cate_id;?>?gem_id=<?=base64_encode($gemstone->id);?>">
...
<div class="row">
  ...
  ?>
      ...
      <a href="<?=base_path?>category_products/<?=$cate_id;?>?s_id=<?=base64_encode($style->id);?>">
...
<div class="panelx">
 <div class="row">
   ...
   ?>
    ...
    <a href="<?=base_path?>category_products/<?=$cate_id;?>?m_id=<?=base64_encode($metal->id);?>">
      ...
      <?php } ?>
       ...
       <label style="padding-left: 40px" for="vehicle1"> <?=$metal->name;?></label></div><br>
    </a>
...
<div class="panelx">
  ...
  <a href="<?=base_path?>category_products/<?=$cate_id;?>?mtr_id=<?=base64_encode($material->id);?>">
...
<div class="panelx">
  <div class="row"  style="padding-left:0px !important;" >
    ...
    <a href="<?=base_path?>category_products/<?=$cate_id;?>?sh_id=<?=base64_encode($shape->id);?>">
     ...
     <label style="padding-left: 40px" for="vehicle1"> <?=$shape->name;?></label></div><br>
    </a>
...
<div class="panelx">
  <div class="row">
    ...
    <a href="<?=base_path?>category_products/<?=$cate_id;?>?pl_id=<?=base64_encode($plating->id);?>">
      ...
      <?php } ?>
       ...
       <label style="padding-left: 40px" for="vehicle1"> <?=$plating->name;?></label></div><br>
    </a>
...
<div class="panelx">
  ...
  <div class="filter" style="padding: 0px 20px;">
    ...
    <div id="sliderPrice" class="filter__slider-price" data-min="0" data-max="500" data-step="1"></div>
...
<section id="product" style="" >
    ...
    <div class="row hello_sec" style="padding-left: 35px;">
        ...
        <div style="width:350px;">
			<h1 style="font-family: 'Calibri'!important;margin-top: 30px;font-size: 30px;"><?=$cat_data->name;?></h1>
  ...
  <?php
   if(!empty($category_pro_data)){
     foreach ($category_pro_data as $subcategory_pro) {
...
if(!empty(Session::get('user_data'))) {
    ...
    <div class="card-body">
      ...
      $pro_type_color1= App\adminmodel\ProductColorSize::wherenull('deleted_at')->where('is_active', 1)->where('product_id', $subcategory_pro->id)->get();
       ...
       <div class="hoverp">
      	<div class="carder" style="background-color:<?if(!empty($color_da->code)){echo $color_da->code;}?>;"></div>
  ...
  <?php
   if(!empty($category_pro_data)){
       ...
       <div class="modal-dialog  modal-lg">
         <div class="modal-content modal-content" >
           ...
           <!-- <div class="modal-header" style="justify-content:flex-end;">
             <h4 class="modal-title" style="    font-family: 'Calibri'!important;"></h4>
     ...
     ?>
                       ...
                       <div class="colorhover1">

                               <button class="colobtn mr-3  p-1 <?php if($i == 0){ echo "active"; } ?> " style="height:25px; width:25px;background:<?=$color_code;?>;border:none; border-radius:50px;" onclick="colorChange(<?=$color_da->id;?>, <?=$subcategory_pro->id;?>);"  ></button>
                                  <div class="colorhide1">


                                    <input type="hidden" value="" id="color_select" name="color_select"><?=$color_da->name?>
                                        </div>
                                      </div>
      ...
      ">
                   <!-- <i class="fa fa-heart-o"></i> -->
           				...
           				<div class="cardtop" style="    font-family: 'Calibri'!important;">
                   <a href="<?=base_path?>products_view/<?=base64_encode($subcategory_pro->id);?>">
           					<h2 style="margin-top: 0;   font-size: 20px;
       font-weight: 600;"><?=$subcategory_pro->name;?></h2>
       <br>
   ...
   ?>
                 ...
                 <?=$sign;?> <span id="price_<?=$subcategory_pro->id;?>" ><?if(!empty($sell_price)){echo $sell_price;}else{echo "no price";}?></span>
...
<?}?>
            ...
            <button class="btn btn-default btn-lg" id="add_to_cart<?=$subcategory_pro->id;?>"
