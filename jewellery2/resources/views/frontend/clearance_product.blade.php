...
<form action="<?=base_path?>sale_products" method="get" >
    ...
    <div class="panel">
     <div class="row">
      ...
      <div class="col-lg-6 col-md-6">
        ...
        <a href="<?=base_path?>sale_products?gem_id=<?=base64_encode($gemstone->id);?>">
...
<div class="row">
  ...
  ?>
      ...
      <a href="<?=base_path?>sale_products?s_id=<?=base64_encode($style->id);?>">
...
<div class="panel">
 <div class="row">
   ...
   ?>
    ...
    <a href="<?=base_path?>sale_products?m_id=<?=base64_encode($metal->id);?>">
...
<div class="panel">
  ...
  <a href="<?=base_path?>sale_products?mtr_id=<?=base64_encode($material->id);?>">
...
<div class="panel">
  <div class="row"  style="padding-left:0px !important;" >
    ...
    <a href="<?=base_path?>sale_products?sh_id=<?=base64_encode($shape->id);?>">
...
<div class="panel">
  <div class="row">
    ...
    <a href="<?=base_path?>sale_products?pl_id=<?=base64_encode($plating->id);?>">
...
<section id="product" style="" >
    ...
    <div class="row hello_sec" style="padding-left: 35px;">
        ...
        <div style="width:200px;">
			<h1 style="    font-family: 'Calibri'!important;margin-top: 30px;font-size: 36px;">Sale </h1>
			...
			<p style="position: absolute;top: 76px;left:55px;"> FILTER & SORT</p>
		    </div>
		</div>
	<div class="row mb-5">

  <?php
   if(!empty($clearance_data)){
     foreach ($clearance_data as $sale_clear) {

       $subcategory_pro= App\adminmodel\Product::wherenull('deleted_at')->where('is_active', 1)->where('is_cat_delete', 0)->where('id', $sale_clear->product_id)->first();
