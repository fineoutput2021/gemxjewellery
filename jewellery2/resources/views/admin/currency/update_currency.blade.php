...
<div class="col-sm-12">
  <div class="page-title-box">
      <h4 class="page-title">Update Currency</h4>
      <ol class="breadcrumb">
...
<!-- End show success and error messages -->
              ...
              <h4 class="mt-0 header-title">Update Currency Form</h4>
              <hr style="margin-bottom: 50px;background-color: darkgrey;">
<form action="<?=base_path?>add_currency_process" method="post" enctype="multipart/form-data">
@csrf

<input class="form-control" type="hidden" value="<?php if(!empty($currency_data)){ echo base64_encode($currency_data->id); }?>" name="currency_id">
...
foreach ($country_data as $country_d) {
          ...
          ?>
          <option value="<?=$country_d->country_name;?>" <?php if($country_d->country_name == $currency_data->country){ echo "selected"; } ?> > <?=$country_d->country_name;?></option>
<?php
} }
?>
			  ...
			  <div class="form-group row">
				  ...
				  <div class="col-sm-10">
					  <input class="form-control" type="text" value="<?php if(!empty($currency_data)){ echo $currency_data->sign; }?>" id="sign" name="sign" required>
												@error('sign')
												<div style= "color:red">{{$message}}</div>
												@enderror
				  </div>
			  ...
			  <div class="form-group row">
				  ...
				  <div class="col-sm-10">
					  <input class="form-control" type="text" value="<?php if(!empty($currency_data)){ echo $currency_data->currency_price; }?>" id="currency_price" name="currency_price" required>
