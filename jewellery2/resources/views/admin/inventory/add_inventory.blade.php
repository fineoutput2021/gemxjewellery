...
<!-- End show success and error messages -->
  ...
  <h4 class="mt-0 header-title">Add Inventory - <?=$product_name;?></h4>
  <hr style="margin-bottom: 50px;background-color: darkgrey;">
<form action="<?=base_path?>add_inventory_process" method="post" enctype="multipart/form-data">
@csrf
<input type="hidden" value="<?=$product_id;?>" name="product_id">
  ...
  <div class="form-group row">
      ...
      <div class="col-sm-10">
          <input class="form-control" type="text" value="" id="stock" name="stock" required>
          @error('stock')
          <div style= "color:red">{{$message}}</div>
          @enderror
      </div>
