...
<div class="row">
<div class="col-md-10"><h4 class="mt-0 header-title">View Inventory List</h4></div>
<div class="col-md-2">  <a class="btn btn-info cticket" href="<?=base_path?>add_inventory_view/<?=$product_id;?>" role="button" style="margin-left: 20px;"> Add Inventory</a></div>
</div>
...
<div class="btn-group">
    <a href="<?=base_path?>remove_inventory_view/<?=$product_id;?>/<?php echo base64_encode($inventory->id)?>">

      <button type="button" class="btn btn-default" > Remove Inventory </button>
