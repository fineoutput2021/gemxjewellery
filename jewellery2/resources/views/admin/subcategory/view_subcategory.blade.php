...
<div class="row">
<div class="col-md-10"><h4 class="mt-0 header-title">View SubCategory List</h4></div>
<div class="col-md-2">  <a class="btn btn-info cticket" href="<?=base_path?>add_subcategory_view" role="button" style="margin-left: 20px;"> Add SubCategory</a></div>
</div>
...
<?php  $activ= $subcategory->is_active;?>
@if($activ == "1")
...
<li><a href="<?=base_path?>update_subcategory_status/active/<?php echo base64_encode($subcategory->id)?>">Active</a></li>
<?php } else { ?>
<li><a href="<?=base_path?>update_subcategory_status/inactive/<?php echo base64_encode($subcategory->id)?>">Inactive</a></li>
<?php		}   ?>

<li><a href="<?=base_path?>update_subcategory_view/<?php echo base64_encode($subcategory->id)?>">Edit</a></li>

<li><a href="javascript:();" class="dCnf" mydata="<?php echo $a ?>">Delete SubCategory</a></li>
</ul>
</div>
</div>
...
<a href="<?=base_path?>deletesubcategory/<?php echo base64_encode($subcategory->id)?>" class="btn btn-danger" >Yes</a>
