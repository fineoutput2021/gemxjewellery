...
<h4 class="page-title">View Product SubCategory</h4>
<ol class="breadcrumb">
...
<div class="row">
<div class="col-md-10"><h4 class="mt-0 header-title">View Product SubCategory List</h4></div>
<div class="col-md-2">  <a class="btn btn-info cticket" href="<?=base_path?>view_product_category" role="button" style="margin-left: 20px;"> Back</a></div>
</div>
...
<div class="btn-group">
  <a href="<?=base_path?>view_product/<?php echo $category_id; ?>/<?php echo base64_encode($subcategory->id)?>">
