...
<div class="col-md-2">  <a class="btn btn-info cticket" href="<?=base_path?>add_category_view" role="button" style="margin-left: 20px;"> Add category</a></div>
</div>
...
<div class="btn-group">
  ...
  <ul class="dropdown-menu" role="menu">
	...
	<li><a href="<?=base_path?>update_cat_status/active/<?php echo base64_encode($category->id)?>">Active</a></li>
	<?php } else { ?>
	<li><a href="<?=base_path?>update_cat_status/inactive/<?php echo base64_encode($category->id)?>">Inactive</a></li>
	<?php		}   ?>

  <li><a href="<?=base_path?>update_category_view/<?php echo base64_encode($category->id)?>">Edit</a></li>
...
<a href="<?=base_path?>deleteCategory/<?php echo base64_encode($category->id)?>" class="btn btn-danger" >Yes</a>
