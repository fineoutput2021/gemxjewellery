...
<div class="col-md-2">  <a class="btn btn-info cticket" href="<?=base_path?>add_color_view" role="button" style="margin-left: 20px;"> Add Color</a></div>
</div>
...
<div class="btn-group" id="btns<?php echo $a ?>">
	<div class="btn-group">
	  ...
	  <ul class="dropdown-menu" role="menu">
		...
		<li><a href="<?=base_path?>update_color_status/active/<?php echo base64_encode($color->id)?>">Active</a></li>
		<?php } else { ?>
		<li><a href="<?=base_path?>update_color_status/inactive/<?php echo base64_encode($color->id)?>">Inactive</a></li>
		<?php		}   ?>


    <li><a href="<?=base_path?>update_color_view/<?php echo base64_encode($color->id)?>">Edit</a></li>
...
<div style="display:none" id="cnfbox<?php echo $a ?>">
	...
	<a href="<?=base_path?>deleteColor/<?php echo base64_encode($color->id)?>" class="btn btn-danger" >Yes</a>
