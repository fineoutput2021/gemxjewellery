...
<!-- End show success and error messages -->
          ...
          <h4 class="mt-0 header-title">Add Sale Form</h4>
          <hr style="margin-bottom: 50px;background-color: darkgrey;">
<form action="<?=base_path?>add_sale_process" method="post" enctype="multipart/form-data">
@csrf
          <div class="form-group row">
              <label for="example-text-input" class="col-sm-2 col-form-label">Name Your Sale &nbsp;<span style="color:red;">*</span></label>
              <div class="col-sm-10">
                  <input class="form-control" type="text" value="" id="sale" name="sale" placeholder="Write Here Your Sale Name..." required>
										@error('sale')
