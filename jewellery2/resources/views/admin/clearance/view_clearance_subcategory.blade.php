...
<h4 class="page-title">View Sale SubCategory</h4>
<ol class="breadcrumb">
<li class="breadcrumb-item"><a href="javascript:void(0);">CMS</a></li>
<li class="breadcrumb-item"><a href="javascript:void(0);">Sale Product</a></li>
<li class="breadcrumb-item active">View Sale SubCategory</li>
</ol>
...
<div class="row">
<div class="col-md-10"><h4 class="mt-0 header-title">View Sale SubCategory List</h4></div>
<div class="col-md-2">  <a class="btn btn-info cticket" href="<?=base_path?>view_sale_category" role="button" style="margin-left: 20px;">Back</a></div>
</div>
...
<div class="btn-group">
  <a href="<?=base_path?>view_sale_add_product/<?php echo $category_id; ?>/<?php echo base64_encode($subcategory->id)?>">
