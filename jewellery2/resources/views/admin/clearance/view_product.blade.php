...
<div class="col-md-2">  <a class="btn btn-info cticket" href="<?=base_path?>view_sale_subcategory/<?php echo $category_id; ?>" role="button" style="margin-left: 20px;">Back</a></div>
...
<?php
$clearance_product= App\adminmodel\Clearance::where('product_id', $product->id)->first();

?>
<?php  if(empty($clearance_product)){ ?>

    <a href="<?=base_path?>add_sale_product/<?=$category_id?>/<?=$subcategory_id?>/<?php echo base64_encode($product->id); ?>">
...
<?php } else{ ?>
    ...
    <a href="<?=base_path?>remove_sale_product/<?=$category_id?>/<?=$subcategory_id?>/<?php echo base64_encode($product->id); ?>">
