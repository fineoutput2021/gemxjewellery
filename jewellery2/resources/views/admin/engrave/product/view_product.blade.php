  ...
  <div class="col-sm-12">
      <div class="page-title-box">
          ...
          <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item"><a href="javascript:void(0);">Engrave Product</a></li>
...
<div class="col-md-2 text-right">  <a class="btn btn-info cticket" href="<?=base_path?>add_engrave_product_view?cate_id=<?=$cate_id?>" role="button" style="margin-left: 20px;"> Add Product</a></div>
<div class="col-md-2">  <a class="btn btn-info cticket" href="<?=base_path?>view_engrave_category" role="button" style="margin-left: 20px;">Back</a></div>
</div>
...
<?php
$category_da= App\adminmodel\EngraveCategory::wherenull('deleted_at')->where('id', $product->category_id)->first();
...
<div class="btn-group">
  ...
  <ul class="dropdown-menu" role="menu">
	...
	<li><a href="<?=base_path?>update_engrave_product_status/active/<?php echo base64_encode($product->id)?>">Active</a></li>
	<?php } else { ?>
	<li><a href="<?=base_path?>update_engrave_product_status/inactive/<?php echo base64_encode($product->id)?>">Inactive</a></li>
	<?php		}   ?>

  <li><a href="<?=base_path?>update_engrave_product_view/<?php echo base64_encode($product->id)?>">Edit</a></li>
...
<a href="<?=base_path?>deleteEngraveProduct/<?php echo base64_encode($product->id)?>" class="btn btn-danger" >Yes</a>
