...
<div class="row">
    <div class="col-sm-12">
        <div class="page-title-box">
            <h4 class="page-title">Update Variant</h4>
            <ol class="breadcrumb">
...
<!-- End show success and error messages -->
                    ...
                    <h4 class="mt-0 header-title">Update Variant Form</h4>
                    <hr style="margin-bottom: 50px;background-color: darkgrey;">
<form action="<?=base_path?>add_size_process" method="post" enctype="multipart/form-data">
@csrf

<input class="form-control" type="hidden" value="<?php if(!empty($size_data)){ echo base64_encode($size_data->id); }?>" name="size_id">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input class="form-control" type="text" value="<?php if(!empty($size_data)){ echo $size_data->name; }?>" id="name" name="name" required>
  													@error('name')
                    ...
                    <!-- <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input class="form-control" type="number" value="<?php if(!empty($size_data)){ echo $size_data->size_price; }?>" id="price" name="price" required>
                            @error('price')
                            <div style= "color:red">{{$message}}</div>
                            @enderror
                        </div>
