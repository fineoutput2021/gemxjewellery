...
@section('main')
 ...
 <!-- End show success and error messages -->
            ...
            <form action="<?=base_path?>add_engrave_product_process" method="post" enctype="multipart/form-data">
			@csrf
      ...
      <input type="hidden" name="cate_id" value="<?=$cate_id;?>">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                  <textarea name="s_desc" class="form-control"  type="text"  id="editor1" rows="4" cols="50" required>
                                                    </textarea>
                                                    <!-- <input class="form-control" type="text" value="" id="s_desc" name="s_desc" required> -->
                                                      @error('s_desc')
                                                      <div style= "color:red">{{$message}}</div>
                                                      @enderror
                                                </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    <input class="form-control" type="text" value="" id="base_price" name="base_price" required>
                                                      @error('base_price')
                                                      <div style= "color:red">{{$message}}</div>
                                                      @enderror
                                                </div>
