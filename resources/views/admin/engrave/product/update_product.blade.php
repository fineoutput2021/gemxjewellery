...
<form action="<?=base_path?>add_engrave_product_process?id=<?php echo base64_encode($pro_id)?>" method="post" enctype="multipart/form-data">
@csrf
    ...
    <input type="hidden" name="cate_id" value="<?php echo base64_encode($pro_cate_id)?>>">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                  <textarea name="s_desc" class="form-control"  type="text"  id="editor1" rows="4" cols="50" required><?=$pro_sdesc;?>
                                    </textarea>
