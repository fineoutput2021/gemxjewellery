...
@section('main')
 ...
 <!-- End show success and error messages -->
            ...
            <form action="<?=base_path?>add_package_process" method="post" enctype="multipart/form-data">
			@csrf
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    ...
                                                    <textarea class="form-control" type="text" value="" id="description" name="description" rows="5"></textarea>
                                                      @error('description')
                                                      <div style= "color:red">{{$message}}</div>
                                                      @enderror
                                                </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    <input class="form-control" type="text" value="" id="buy_price" name="buy_price" required>
                                                      @error('buy_price')
                                                      <div style= "color:red">{{$message}}</div>
                                                      @enderror
                                                </div>
...
<?php $currentDateTime = date('Y-m-d') ?>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    <input class="form-control" type="input" value="" id="validity" name="validity" required>
                                                      @error('validity')
                                                      <div style= "color:red">{{$message}}</div>
                                                      @enderror
                                                </div>
