...
<h4 class="page-title">View Inventory Category</h4>
<ol class="breadcrumb">
<li class="breadcrumb-item"><a href="javascript:void(0);">CMS</a></li>
<li class="breadcrumb-item"><a href="javascript:void(0);">Inventory</a></li>
<li class="breadcrumb-item active">View Inventory Category</li>
</ol>
...
<div class="row">
<div class="col-md-10"><h4 class="mt-0 header-title">View Inventory Category List</h4></div>
...
<div class="btn-group">
  <a href="<?=base_path?>view_inventory_subcategory/<?php echo base64_encode($category->id)?>"  >
