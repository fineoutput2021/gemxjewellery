...
@section('main')
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="page-title-box">
                                    <h4 class="page-title">Add MiniSubCategory</h4>
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item"><a href="javascript:void(0);">CMS</a></li>
                                        <li class="breadcrumb-item"><a href="javascript:void(0);">MiniSubCategory</a></li>
                                        <li class="breadcrumb-item active">Add MiniSubCategory</li>
                                    </ol>
 ...
 <!-- End show success and error messages -->
    ...
    <h4 class="mt-0 header-title">Add MiniSubCategory Form</h4>
    <hr style="margin-bottom: 50px;background-color: darkgrey;">
<form action="<?=base_path?>add_minisubcategory_process" method="post" enctype="multipart/form-data">
@csrf
