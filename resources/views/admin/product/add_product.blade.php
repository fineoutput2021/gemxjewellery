...
<form action="<?=base_path?>add_product_process/<?=$category_id?>/<?=$subcategory_id?>" method="post" enctype="multipart/form-data">
@csrf
          ...
          <div class="form-group row">
              ...
              <div class="col-sm-10">
                  <!-- <input class="form-control" type="text" value="" id="sdesc" name="sdesc" required> -->
