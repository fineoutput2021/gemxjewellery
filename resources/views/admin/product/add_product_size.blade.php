...
<!-- End show success and error messages -->
                    ...
                    <h4 class="mt-0 header-title">Add Size Form</h4>
                    <hr style="margin-bottom: 50px;background-color: darkgrey;">
<form action="<?=base_path?>add_product_size_process" method="post" enctype="multipart/form-data">
@csrf
...
<input type="hidden" value="<?=$product_id;?>" name="product_id">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                          <select name="size_id" id="cid" class="form-control" required >
                    ...
                    <!-- <div class="form-group row">
                        <label for="example-text-input" class="col-sm-2 col-form-label">Size price &nbsp;<span style="color:red;">*</span></label>
                        <div class="col-sm-10">
