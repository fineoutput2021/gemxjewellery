            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="success-text" style="line-height:60px;text-align:center;font-family: Lato, sans-serif;"><i class="fa fa-check-circle" aria-hidden="true" style="font-size: 50px;color: #4ead4e;"></i>
                        <h2 style="text-transform:uppercase;">thank you</h2>
                        <p style="font-size: 18px;  text-transform: capitalize;">Package is successfully subscribed and now you enjoy purchasing with us.</p>
                        <!-- <a style="margin-right:18px;" href="#" class="btn btn-solid">View Orders</a> -->
