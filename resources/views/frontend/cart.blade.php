...
img{border:0;}
/*! CSS Used from: Embedded */
.css-10xun30{white-space:nowrap;text-overflow:ellipsis;color:rgb(51, 54, 62);font-size:1.1rem;line-height:1.8rem;margin-bottom:0.4rem;}
...
.css-106pwyk{font-size:1.1rem;display:flex;flex-direction:row;margin-bottom:0.2rem;justify-content: space-between;}
...
@media (min-width: 993px){
.css-bi61qn{flex-direction:row;padding:0.6rem;background-color:rgb(255, 255, 255);margin-bottom:2.4rem;border:1px solid rgb(233, 233, 233);border-radius:0.4rem;}
}
  ...
  <div class="container-fluid">
    <div class="row">
      <div class="col-lg-9 col-md-9 p-0" style="min-height:75vh;">
        ...
        <div class="css-1aspwm4 eclstbm5  h1res d-flex justify-content-between" style="font-size: 30px;font-weight: 700;margin-top:2rem;margin-bottom:2rem;font-family: 'Calibri'!important;">Your Shopping Bag <span class="savecart"></span>
          <div class="d-flex">
...
<!-- <div class="/*crossbtn float-right" style="/*justify-content:end; display:flex;">
  <a href="<?=base_path?>delete_product_cart/<?=base64_encode($cart['product_id'])?>/<?=base64_encode($cart['color_id'])?>"  >
...
<div class="css-on8ti6 ee3or4p2">
  ...
  <div class="css-1tnay0n cart-item-content">
    <div class="row pt-0">
      <span class="text-right" ><a  href="<?=base_path?>delete_product_cart/<?=base64_encode($cart['product_id'])?>/<?=base64_encode($cart['color_id'])?>"  >
        <img src="https://img.icons8.com/external-becris-lineal-becris/25/000000/external-cancel-mintab-for-ios-becris-lineal-becris.png" style="width: 12px;"/>
      </a></span>
<div class="col-md-4">
...
<div class="drop-down css-1geyf33 ey3901i0 ml-0">
<select id="color_selct_<?=$product->id;?>" class="color_selct" pro_id="<?=$product->id;?>">
...
<input type="number" onkeydown="if(event.key==='.'){event.preventDefault();}"  oninput="event.target.value = event.target.value.replace(/[^0-9]*/g,'');" class="ml-0" id="qt_<?=$product->id;?>" value="<?=$cart['quantity'];?>" min="1" onchange="updateQuantityCartlocal(event ,<?=$cart['color_id']?>,<?=$product->id;?> )" />
</span>
</div>
</div>
<div class="col-md-4">
...
<?php if($cart['status'] == 1){
  ...
  <div class="cart-item-card css-bi61qn ee3or4p0">
    <!-- <span class="text-right"> <a onclick="delete_sc_custom(<?=$cart['product_id']?>,<?=$cart['metal']?>,<?=$cart['stone'];?>)" href="javascript:void(0);" >
      <img src="https://img.icons8.com/external-becris-lineal-becris/25/000000/external-cancel-mintab-for-ios-becris-lineal-becris.png" style="width: 12px;"/>
    </a></span> -->
  <div class="css-on8ti6 ee3or4p2">
    <div>
    ...
    <div class="css-1tnay0n cart-item-content">
      ...
      <div class="row p-0">
        <span class="text-right"><a href="javascript:void(0)" onclick="delete_sc_custom(<?=$cart['product_id']?>,<?=$cart['metal']?>,'<?=$cart['stone'];?>')">
          <img src="https://img.icons8.com/external-becris-lineal-becris/25/000000/external-cancel-mintab-for-ios-becris-lineal-becris.png" style="width: 12px;">
        </a></span>
        ...
        <div class="col-md-9">
          ...
          <div class="col-md-4">
            ...
            <span>Size :</span>
            <div class="drop-down css-1geyf33 ey3901i0">
            <?if(!empty($cart['size'])){echo $cart['size'];}else{echo "no size";}?>
            </div>
            </div>
            <?}?>
            <div class="cart-item-qty /*css-1kb8zzg*/ eay09df2">
            ...
            <div class="drop-down css-1geyf33 ey3901i0  p-2"  style="margin-right:0px;margin-left:0px;overflow:visible !important;white-space:nowrap !important;padding: 0px !important;">


                  <?if(!empty($productcolorsizeprices->name)){echo $productcolorsizeprices->name;}else{echo "no name";}?>
          ...
          <div class="col-md-3">
            ...
            <h5 style="top:2px"><b>Quantity</b></h5>
            <span class="css-qhuuwl eay09df1">
            <input type="number"  style="margin-left:0px;width:70% !important;" id="qt_<?=$custom_product->id;?>" value="<?=$cart['quantity'];?>" value="<?=$cart['quantity'];?>" min="1"style="30% !important" />
            </span>
            </div>
            </div>
            <div class="col-md-3">
...
?>
  ...
  <!-- <div class="cart-item-qty css-1kb8zzg eay09df2">
  <span><b>Stone :</b></span>
  <div class="drop-down css-1geyf33 ey3901i0" style="width:fit-content;">
...
<?}?>
  <!-- <div class="cart-item-qty css-1kb8zzg eay09df2"><span><b>Quantity :</b></span>
  <span class="css-qhuuwl eay09df1">
  <input type="number" id="qt_<?=$custom_product->id;?>" value="<?=$cart['quantity'];?>" min="1" readonly />
  </span>
...
<div class="row p-0">
  <span class="text-right"><a href="javascript:void(0)"  onclick='delete_sc_ecustom(<?=$cart["product_id"]?>,'<?=$cart["engrave_text"]?>','<?=$cart["font_family"]?>',<?=$cart["font_size"];?>)'>
  <img src="https://img.icons8.com/external-becris-lineal-becris/25/000000/external-cancel-mintab-for-ios-becris-lineal-becris.png" style="width: 12px;">
  </a></span>
  <div class="col-md-3">
<h5 style="top:2px"><b>Product Name</b></h5>
<p class="css-10xun30 cart-item-product-name"><?=$engrave_product->name;?></p>
  ...
  <div class="col-md-9">
    ...
    <div class="col-md-3">
      <div class="cart-item-qty /*css-1kb8zzg*/ eay09df2"><h5  style="top:2px"><b>Quantity :</b></h5>
      <span class="css-qhuuwl eay09df1">
      <input type="number" id="qt_<?=$engrave_product->id;?>" value="<?=$cart['quantity'];?>" min="1" style="margin-left:0px;margin-right:0px;width: 60%;" readonly/>
      </span>
  ...
  ?>
    ...
    <!-- <div class="cart-item-qty css-1kb8zzg eay09df2"><span><b>Quantity :</b></span>
    <span class="css-qhuuwl eay09df1">
    <input type="number" id="qt_<?=$engrave_product->id;?>" value="<?=$cart['quantity'];?>" min="1" readonly/>
    </span>
...
@endforeach
@else
<button class="epypi6q0 e1jmj0hg1 css-17fmasb e1jmj0hg0"></span>Your cart is empty</button>
@endif
...
?>
      ...
      <div class="col-lg-3 col-md-3 mt-md-5" style="position:sticky;right: 0;top:0;">
  ...
  top: 207px !important;">
          ...
          <div id="order-summary" data-name="order-summary-box" class="css-ry2i6z e1r0aisc2">
           ...
           <div class="css-1c2kahj web_che">
              ...
              <a href="<?=base_path?>open_login/<?=base64_encode(1)?>">
                ...
                <label class="ml-5" style="color:red;">Please login/Register for checkout</label>
              </a>
          </div>
       </div>
      </div>
...
function updateQuantityCartlocal(event ,color_id, product_id){
...
$.ajax({
 url:base_path+'update_cart',
 method: 'post',
 data: {color_id: color_id, product_id: product_id, quantity: quantity, _token: '{{csrf_token()}}' },
 dataType: 'json',
...
//Update quantity in table onChange
function delete_sc_custom(product_id,metal,stone){
// alert(product_id);
// alert(metal);
// alert(stone);
...
var base_path = $("#base_path").val();
$.ajax({
 url:base_path+'delete_sc_custom',
 method: 'post',
 data: {product_id: product_id, metal: metal,stone:stone,_token: '{{csrf_token()}}' },
 dataType: 'json',
 success: function(response){
...
//Update quantity in table onChange
function delete_sc_ecustom(product_id,engrave_text,font_family,font_size){
// alert(product_id);
// alert(engrave_text);
// alert(font_family);
// alert(font_size);
var base_path = $("#base_path").val();
$.ajax({
 url:base_path+'delete_sc_ecustom',
 method: 'post',
 data: {product_id: product_id, engrave_text: engrave_text,font_family:font_family,font_size:font_size,_token: '{{csrf_token()}}' },
 dataType: 'json',
 success: function(response){
// alert(response);
...
//
//
// +'<p class="css-mtc8vw cart-item-price prices">&#8377;'
...
// function removeFromTblCart(cart_id, prod_id){
//
// var base_path = $("#base_path").val();
//
// $.ajax({
